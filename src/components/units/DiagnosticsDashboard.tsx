import { Activity, Clock, Server, ArrowRight, CheckCircle2, AlertTriangle, Users, Bot, Code, Languages, FileText, ChevronRight, MessageSquare } from "lucide-react";
...
export const DiagnosticsDashboard = ({ data, onClose }: DiagnosticsDashboardProps) => {
    if (!data) return null;
            ...
            <div className="sticky top-0 z-10 flex items-center justify-between p-6 bg-neutral-900/80 backdrop-blur-md border-b border-neutral-800">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-neutral-400 text-sm">Call SID: <span className="font-mono text-neutral-300">{call_id || "N/A"}</span></p>
                    </div>
                </div>
